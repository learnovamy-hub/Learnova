...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void _proceed() {
    if (selectedForm == 0 || selectedSubjects.isEmpty) return;
    try {
  ...
  Widget build(BuildContext context) {
    final canProceed = selectedForm > 0 && selectedSubjects.isNotEmpty;
    return Scaffold(
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Center(child: Text(
                canProceed ? "Let's go!  Form $selectedForm  ${selectedSubjects.length} subjects" : selectedForm == 0 ? "Select your form level first" : "Select at least one subject",
